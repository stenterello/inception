...
wp core install --url=$DOMAIN_NAME/wordpress --title="Inception" --admin_user=$WP_DATABASE_USR --admin_password=$WP_DATABASE_PWD --admin_email=$WP_DATABASE_EMAIL --skip-email --allow-root
